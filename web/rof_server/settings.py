"""
Django settings for runningOnFumesServer project.
...
INSTALLED_APPS = [
    'high_scores.apps.HighscoresConfig',
...
WSGI_APPLICATION = 'rof_server.wsgi.application'
